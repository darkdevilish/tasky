...
describe Action do
  ...
  it "returns all pending tasks" do
    pending_tasks = Task.where(:completed=>false).all

    @action.list_pending.must_equal pending_tasks
  end
